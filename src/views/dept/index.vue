...
const handleDelete = (row) => {
  ...
  ElMessageBox.confirm('此操作将永久删除该科室, 是否继续?', '提示', {
...
<template>
  ...
  <!-- 按钮靠页面右侧显示 -->
  <el-button type="primary" @click="add()" style="float: right;"> + 新增科室</el-button> <br><br>

  <!-- 数据展示表格 -->
  <el-table :data="tableData" border style="width: 100%;">
    <el-table-column type="index" label="序号" width="100" align="center"/>
    <el-table-column prop="name" label="科室名称" width="300" align="center"/>
  ...
  <el-dialog v-model="showDialog" :title="formTitle" width="30%" @close="resetForm">
    <el-form :model="deptForm" :rules="formRules" ref="deptFormRef">
      <el-form-item label="科室名称" prop="name" label-width="80px">
