...
//职位列表数据
const jobs = ref([{ name: '主任医师', value: 1 },{ name: '副主任医师', value: 2 },{ name: '主治医师', value: 3 },{ name: '医师', value: 4 },{ name: '医士', value: 5 },{ name: '其他', value: 6 }])
//性别列表数据
...
<template>
  ...
  <el-table :data="empList" border style="width: 100%" @selection-change="handleSelectionChange">
    ...
    <el-table-column prop="deptName" label="科室名称" width="200" align="center"></el-table-column>
    ...
    <el-table-column prop="updateTime" label="最后操作时间" width="250" align="center"></el-table-column>
  ...
  <el-dialog v-model="dialogVisible" :title="dialogTitle">
      <el-form ref="employeeFormRef" :model="employee" :rules="rules" label-width="80px">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="所属科室">
              <el-select v-model="employee.deptId" placeholder="请选择科室" style="width: 100%;">
        ...
        <el-row :gutter="3" v-for="(expr, index) in employee.exprList">
          ...
          <el-col :span="6">
            <el-form-item size="small" label="医院" label-width="60px">
              <el-input placeholder="请输入医院名称" v-model="expr.company"></el-input>
            </el-form-item>
          </el-col>
